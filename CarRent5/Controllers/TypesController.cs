...
namespace CarRent5.Controllers
{
    public class TypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TypeName,Price")] Type type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TypeName,Price")] Type type)
        {
            if (ModelState.IsValid)
            {
